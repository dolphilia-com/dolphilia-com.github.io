...
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>このブロックは、<code>skia_compile_modules</code>または<code>skia_compile_sksl_tests</code>が有効な場合、SKSLモジュールのソースファイルを指定のディレクトリにコピーする設定を行います。コピー元のソースファイルとコピー先のディレクトリが定義されています。</p><p>571行まで</p>`,91),i=[l];function t(o,c,u,r,d,_){return a(),n("div",null,i)}const g=s(e,[["render",t]]);export{h as __pageData,g as default};
