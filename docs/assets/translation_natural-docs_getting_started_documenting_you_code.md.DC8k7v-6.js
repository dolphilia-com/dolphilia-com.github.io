import{_ as s,c as a,o as n,a3 as i}from"./chunks/framework.DflgEAq4.js";const u=JSON.parse('{"title":"Natural Docsによるコードの文書化（日本語訳）","description":"","frontmatter":{},"headers":[],"relativePath":"translation/natural-docs/getting_started/documenting_you_code.md","filePath":"translation/natural-docs/getting_started/documenting_you_code.md","lastUpdated":1741276236000}'),p={name:"translation/natural-docs/getting_started/documenting_you_code.md"},e=i(`<h1 id="natural-docsによるコードの文書化-日本語訳" tabindex="-1">Natural Docsによるコードの文書化（日本語訳） <a class="header-anchor" href="#natural-docsによるコードの文書化-日本語訳" aria-label="Permalink to &quot;Natural Docsによるコードの文書化（日本語訳）&quot;">​</a></h1><p><a href="https://www.naturaldocs.org/getting_started/documenting_your_code/" target="_blank" rel="noreferrer">原文</a></p><h2 id="基本" tabindex="-1">基本 <a class="header-anchor" href="#基本" aria-label="Permalink to &quot;基本&quot;">​</a></h2><p>いよいよコードの文書化を開始するときが来ました。文書化を非常に簡単かつ苦痛にならないようにするため、すぐに飛び込んでみましょう。</p><div class="language-c vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">c</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// Function: Multiply</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">*/</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">enum</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> CounterMode { Normal, Odd, Even };</span></span></code></pre></div><p>CounterModeだけでなく、CounterMode.Oddへのリンクも可能になりました。</p>`,98),l=[e];function t(h,c,r,d,o,k){return n(),a("div",null,l)}const y=s(p,[["render",t]]);export{u as __pageData,y as default};
